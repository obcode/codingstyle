 ...
 */
public class LineRange16 extends LineRange {
    private final int from;
    private final int to;

    public LineRange16(final int line) {
        this(line, line);
    }

    public LineRange16(final int from, final int to) {
        super(1, 3);
    ...
    public boolean contains(final int value) {
        return contains(new LineRange(value));
    }

    public boolean contains(final LineRange other) {
