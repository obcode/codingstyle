 ...
 */
public class LineRange13 extends LineRange {
    private final int from;
    private final int to;

    public LineRange13(final int line) {
        this(line, line);
    }

    public LineRange13(final int from, final int to) {
        super(1, 3);
    ...
    public boolean intersects(final LineRange other) {
        return from <= other.values()[0] && to > other.values()[other.size() - 1];
    }
