 ...
 */
public class LineRange2 extends LineRange {
    private final int from;
    private final int to;

    public LineRange2(final int line) {
        this(line, line);
    }

    public LineRange2(final int from, final int to) {
        super(1, 3);
    ...
    public int[] values() {
        ...
        for (int i = 0; i < elements.length; i++) {
            elements[elements.length - i - 1] = from + i;
        }
        return elements;
    }
